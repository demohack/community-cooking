...
var CardGame = function (targetId) {
  ...
  {
    cards[id].firstChild.src = "/cards/static/images/back.png";
    with(cards[id].style) {
  ...
  var showCard = function (id) // turn card face up, check for match
  {
    ...
    cards[id].firstChild.src = "/cards/static/images/" + card_value[id] + ".png";
    with(cards[id].style) {
  ...
  card.innerHTML = "<img src=\"/cards/static/images/back.png\">";
